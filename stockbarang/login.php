...
if(isset($_POST['login'])){
    ...
    //cocokin dengan database, untuk mencari ada atau ga nya data
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="username" id="inputUsername" type="username" placeholder="username" />
                                            </div>
                                            <div class="form-group">
